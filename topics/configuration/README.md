...
to delay for each individual request. The driver's paging mechanism can be use
...
wait for one or more nodes to response back to the coordinator node before a
request can complete. In multi-datacenter configures consistency levels such as
